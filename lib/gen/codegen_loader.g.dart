...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> en_US = {
    ...
    "about_me": {
      ...
      "bullet_point_2":
          "I believe in lifelong learning and self-improvement. Whether it's mastering a new programming language, optimizing code efficiency, or enhancing my English communication skills, I continuously strive to grow.",
      "bullet_point_3":
  ...
  static const Map<String, dynamic> vi_VN = {
    ...
    "about_me": {
      ...
      "bullet_point_2":
          "Tôi tin vào việc học tập và tự hoàn thiện suốt đời. Dù là làm chủ một ngôn ngữ lập trình mới, tối ưu hóa hiệu quả code, hay nâng cao kỹ năng giao tiếp tiếng Anh, tôi luôn nỗ lực để phát triển.",
      "bullet_point_3":
          "Tôi luôn biết ơn những người mentors và đồng nghiệp đã giúp tôi trưởng thành, hướng dẫn tôi vượt qua các thách thức kỹ thuật và phát triển sự nghiệp.",
      "bullet_point_4":
